# ==============================================================================
# SCRIPT DE MODÉLISATION ROBUSTE : NO2 (Dioxyde d'Azote)
# ==============================================================================
rm(list = ls()) # On nettoie l'environnement pour éviter les conflits avec PM2.5
...
print(paste("Station NO2 sélectionnée :", nom_championne))
...
# ==============================================================================
print("--- ETAPE 2 : Data Splitting NO2 (80/10/10 - Aligné Minuit) ---")
...
# ==============================================================================
# ETAPE 3-Bis : CHOIX DE LA DIFFÉRENCIATION (NO2)
# ==============================================================================
library(forecast)
library(ggplot2)

print("--- COMPARAISON DES DIFFÉRENCIATIONS (NO2) ---")
...
# ==============================================================================
# LE MATCH ULTIME NO2 : MA vs AR vs COMBINÉ
# ==============================================================================
library(forecast)
library(Metrics)
...
model_combo <- Arima(ts_train, order=c(2,1,2), seasonal=list(order=c(0,1,1), period=24))
...
rmse_ma2   <- get_rmse_val(model_ma2)
rmse_ar2   <- get_rmse_val(model_ar2)
rmse_combo <- get_rmse_val(model_combo)

print(paste("RMSE Val - MA(2)   :", round(rmse_ma2, 2)))
...
if(winner_name == "MA2") {
  ...
  titre_model <- "SARIMA(2,1,2)(0,1,1)[24]"
}
...
ggplot(df_res, aes(x=Heure)) +
  ...
  # Courbes
  geom_line(aes(y=Reel, color="Réel (NO2)"), size=0.8) +
