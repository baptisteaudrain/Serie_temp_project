# ==============================================================================
# BACKEND 2 : PM2.5 - VERSION PARALLÈLE (Précision maximale)
# ==============================================================================
...
cat("Stations PM2.5 urbaines actives au", as.character(DATE_LIMITE_SIMU), ":\n")
print(stations_actives)

if (length(stations_actives) == 0) {
  stop("ERREUR : aucune station PM2.5 urbaine active à cette date limite.")
}
